...
@ExperimentalCoilApi
@Composable
fun MotivationDetailScreen(
    viewModel: MotivationDetailViewModel = hiltViewModel(),
    navController: NavHostController
) {

    val motivation by viewModel.selectedMotivationState.collectAsState()
